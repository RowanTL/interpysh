...
def run():
    ...
    file_path_label.grid(row = 0)
    file_path_button.grid(row = 1)
    load_push_code_button.grid(row = 2)
    interpret_one_step_button.grid(row = 3)
    previous_step_button.grid(row = 4)
    interpret_all_button.grid(row = 5)
    exec_label.grid(row = 6)
    code_label.grid(row = 7)
    int_label.grid(row = 8)
    float_label.grid(row = 9)
    str_label.grid(row = 10)
    char_label.grid(row = 11)
    vector_int_label.grid(row = 12)
    vector_float_label.grid(row = 13)
    vector_str_label.grid(row = 14)
    vector_char_label.grid(row = 15)
